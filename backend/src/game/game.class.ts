...
export class Game {
  ...
  private _check_ball_collide_wall(ball: Ball) {
    ...
    if (ball.position.y > this.game_state.gameInfos.height - Default_params.BALL_RADIUS) {
      ball.position.y = this.game_state.gameInfos.height - Default_params.BALL_RADIUS;
      ball.direction.y *= -1;
    }
  }
