...
describe('Appe@e', () => {
  ...
  describe('Match', () => {
    ...
    describe(':id', () => {
      ...
      it('Should thrown with a bad id', async () => {
        const token = await JWT_access(2);
        return pactum.spec().get('/match/0').withHeaders({
          Authorization : 'Bearer ' + token,
        }).expectStatus(404);
      })
  ...
  describe('Users', () => {
    describe(':id', () => {
      ...
      it('Should thrown with a bad id', async () => {
        const token = await JWT_access(2);
        return pactum.spec().get('/user/0',).withHeaders({
          Authorization : 'Bearer ' + token,}).expectStatus(404);
      });
      it('Should work', async () => {
        const token = await JWT_access(2);
        return pactum.spec().get('/user/1',).withHeaders({
          Authorization : 'Bearer ' + token,}).expectStatus(200);
      });
    })
    describe('setnickname', () => {
      ...
      it('Should thrown no body', async () => {
        const token = await JWT_access(2);
        return pactum.spec().patch('/user/setnickname',).withHeaders({
          Authorization : 'Bearer ' + token,}).expectStatus(400);
      });
      it('Should work', async () => {
        const token = await JWT_access(2);
        return pactum.spec().patch('/user/setnickname',).withHeaders({
          Authorization : 'Bearer ' + token,}).withBody({
            nickname: 'test',
          }).expectStatus(200);
      });
  ...
  describe('Achievement', () => {
    ...
    it('Should work', async () => {
      ...
      return pactum.spec().post('/achievements',).withHeaders({
        Authorization : 'Bearer ' + token,}).expectStatus(201);
    });
      describe('add (admin only)', () => {
        ...
        it('Should thrown not admin', async () => {
          ...
          return pactum.spec().post('/achievements/add',).withHeaders({
            Authorization : 'Bearer ' + token,}).expectStatus(403);
        });
        it('Should thrown no body send', async () => {
      ...
      describe('modif (admin only)', () => {
        ...
        it('Should thrown not admin', async () => {
          const token = await JWT_access(2);
          return pactum.spec().patch('/achievements/2',).withHeaders({
            Authorization : 'Bearer ' + token,}).expectStatus(403);
        });
        it('Should thrown bad id send', async () => {
          const token = await JWT_access(1);
          return pactum.spec().patch('/achievements/999999',).withHeaders({
            Authorization : 'Bearer ' + token,}).expectStatus(400);
        });
        it('Should thrown no body send', async () => {
          const token = await JWT_access(1);
          return pactum.spec().patch('/achievements/$S{achievementId}',).withHeaders({
            Authorization : 'Bearer ' + token,}).expectStatus(400);
        });
        it('Should work', async () => {
          const token = await JWT_access(1);
      ...
      describe('Add to user (admin only)', () => {
        it('Should thrown not connected', async () => {
          return pactum.spec().post('/achievements/add/0/$S{achievementId}',).expectStatus(401);
        });
        it('Should thrown not admin', async () => {
          const token = await JWT_access(2);
        ...
        it('Should thrown bad achievement id send', async () => {
          const token = await JWT_access(1);
          return pactum.spec().post('/achievements/add/1/0',).withHeaders({
            Authorization : 'Bearer ' + token,}).expectStatus(403);
        });
        it('Should work', async () => {
          const token = await JWT_access(1);
          return pactum.spec().post('/achievements/add/2/$S{achievementId}',).withHeaders({
            Authorization : 'Bearer ' + token,}).expectStatus(403);
        });
      })
      describe('get user achievement', () => {
        ...
        it('Should thrown bad id send', async () => {
          ...
          return pactum.spec().post('/achievements/0',).withHeaders({
            Authorization : 'Bearer ' + token,}).expectStatus(403);//TODO change the execption code NOT 403
        });
        it('Should work', async () => {
          const token = await JWT_access(2);
          return pactum.spec().post('/achievements/2',).withHeaders({
            Authorization : 'Bearer ' + token,}).expectStatus(200);
        });
      })
      describe('delete (admin only)', () => {
        ...
        it('Should work', async () => {
          ...
          return pactum.spec().delete('/achievements/$S{achievementId}',).withHeaders({
            Authorization : 'Bearer ' + token,}).expectStatus(204);
        });
      })
  })
});
