  ...
  return (
    <div>
      <Button
        ...
        onClick={
          /*user.avatar !== String(members[id as any]) // catch isNotUserActive
				?*/ handleAClick
          /* : () => {} */
        }
      >
                ...
                <IconButton
                  ...
                  onClick={
                    statusUtils.isUserBlocked(user, props.member.memberId)
                      ? () =>
                          onClickUtils.onUnBlockClick(
                            socket,
                            user,
                            props.member.memberId
                          )
                      : () =>
                          onClickUtils.onBlockClick(
                            socket,
                            user,
                            props.member.memberId
                          )
